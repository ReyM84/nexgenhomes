    ...
    <div>
      <ContainerDiv>
        ...
        <CarouselC autoPlay="true" infiniteLoop="true">
          ...
          <div>
            <img alt="past housing project" src="./Assets/IMG_0940.JPG" />
          </div>
          <div>
            <img alt="past housing project" src="./Assets/IMG_1374.JPG" />
          </div>
          <div>
            <img alt="past housing project" src="./Assets/IMG_0593.JPG" />
          </div>
          <div>
            <img
              alt="past housing project"
